...
const jobTypes = {
    bull: bull_job_1.BullJob,
    sync: sync_job_1.SyncJob,
};
class QueueManager {
    constructor(queueManagerOptions) {
        ...
        const jobName = queueManagerOptions.type || this.defaultOptions.type;
    ...
    listenAll(queues, callback) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.job.listenAll(queues, callback);
        });
    }
    close() {
        return __awaiter(this, void 0, void 0, function* () {
